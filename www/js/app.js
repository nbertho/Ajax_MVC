$(function functionName() {
  ...
  // FONCTIONS
    ...
    // FONCTION POUR AFFICHER TOUTES LES TACHES
      function showAllTasks() {
        $('.todo-list').children('li').slideDown(400, function() {
          $(this).show();
        })
      }
  ...
  // EVENEMENTS
    ...
    // ACTIVATION DES FILTRES (EN COURS - TOUTES)
      // Filtres terminées
      $('.filters').on('click', '.completed', function() {
        // Affichages de toutes les taches
        showAllTasks();
        // Retrait des taches non-completées
        $('.todo-list').children('li').not('.completed').slideUp(400, function() {
          $(this).hide();
        })
      });
